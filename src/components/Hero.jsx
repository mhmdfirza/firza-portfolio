  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        {/* Name */}
        <h1
          className={`text-6xl sm:text-7xl md:text-8xl font-bold tracking-tight mb-6 transition-all duration-1000 ${
        ...
        {/* Role */}
        <p
          className={`text-lg md:text-xl text-white/50 font-light tracking-wide transition-all duration-1000 delay-200 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
